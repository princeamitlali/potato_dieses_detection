...
# print start time
print ("[INFO] program started on - " + str(datetime.now()))

# get the input and output path
input_path  = "/home/prince/potato/flower-recognition/dataset/17flowers/jpg"
output_path = "/home/prince/potato/flower-recognition/dataset/output/train"
...
# print end time
print ("[INFO] program ended on - " + str(datetime.now()))